...
def pingpong_helper(n, pingpong, k, index = 1):
    if index == n:
        return pingpong 
        ...
        if k == 0:   
           return pingpong_helper(n + 1, pingpong - 1, k, index)
        elif k == 1:
           return pingpong_helper(n + 1, pingpong + 1, k, index)
...
def count_coins(change):
    ...
    """
    "*** YOUR CODE HERE ***"
    return count_coins_help(change, 25)



def count_coins_help(change, i):
    if change == 0:
        return 1
    elif change < 0:
        return 0
        ...
        return count_coins_help(change - i, i) + count_coins_help(change, next_smaller_coin(i))
